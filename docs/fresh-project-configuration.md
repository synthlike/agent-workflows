...
A fresh installation needs `configure-project` and the workflows the user explicitly selects. It may initially omit transitive dependencies; `configure-project` calculates and adds the missing closure from the matching verified release bundle.
