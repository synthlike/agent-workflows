...
This is the human-readable dependency table for selective installations. Exact skill names in `SKILL.md` inline code are the authoritative dependency declarations; both this table and the [v0.2 release manifest](release-manifest.md) are verified against them.
