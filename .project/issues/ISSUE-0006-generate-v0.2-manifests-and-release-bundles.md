...
- [x] A deterministic release archive contains the manifest, complete skill directories, lifecycle assets through `configure-workflows`, and changelog information.
